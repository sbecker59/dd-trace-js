...
class ConfluentKafkaJavascriptProducerPlugin extends ProducerPlugin {
  ...
  constructor () {
    super(...arguments)
    this.addSub('apm:confluent-kafka-javascript:produce:commit', message => this.commit(message))
  }
   ...
   * @property {import('confluent-kafka-javascript/utils/long').Long} [baseOffset]
   *
...
module.exports = ConfluentKafkaJavascriptProducerPlugin
